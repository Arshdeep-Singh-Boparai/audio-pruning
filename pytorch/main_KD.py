...
def train(args):
    ...
    if(model_type == "mobilenet"):
        ...
        model_teacher = Model_teacher(sample_rate=sample_rate, window_size=window_size, hop_size=hop_size, mel_bins=mel_bins, fmin=fmin, fmax=fmax, classes_num=classes_num)#, pooling_factor=pooling_factor, pooling_type=pooling_type)
    ...
    for batch_data_dict in train_loader:
        ...
        if 'mixup' in augmentation:
            ...
            with torch.no_grad():
            	batch_data_dict_teacher = model_teacher(batch_data_dict['waveform'],None)
        else:
