...
# October 2018
# Modified by Aryan Chaudhary IIIT Delhi,2023
##########################################################
...
def quaternion_conv(input, r_weight, i_weight, j_weight, k_weight, bias, stride,
    ...
    # print("r_weight", r_weight.shape)
    cat_kernels_4_r = torch.cat([r_weight, -i_weight, -j_weight, -k_weight], dim=1)
    # print("shape of kernel for r",cat_kernels_4_r.shape)
    ...
    # print("dumping the Quaternion matrix of shape", cat_kernels_4_quaternion.shape)
    # print("call count",call_count)
    # import numpy as np
    # with open(f'/home/air/ARYAN_MT22019/BC-ResNet/Matrixdump/Matchboxnet/convweight{call_count}.pkl', 'wb') as f:
    #      call_count = call_count+1
    #      cat_kernels_4_quaternion.detach().numpy().dump(f)
