...
def train(args):
    ...
    if(model_type == "mobilenet"):
        ...
        model = Model(sample_rate=sample_rate, window_size=window_size, hop_size=hop_size, mel_bins=mel_bins, fmin=fmin, fmax=fmax, classes_num=classes_num)#, pooling_factor=pooling_factor, pooling_type=pooling_type)
    print(model) 
