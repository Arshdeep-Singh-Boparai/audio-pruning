...
```
## Transfer learning on other audio classifcation task
Please follow the [link](https://github.com/Arshdeep-Singh-Boparai/Transfer_learning_QuaternionCNN.git) for details.
